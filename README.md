# Hostinger KVM 8 -- Independent Forensic Infrastructure Audit
...
![CPU Limitation Activated -- hPanel notification on a KVM 8 VPS sold with "dedicated" resources. The SAE team confirmed June 9 this limitation was active for over a week before any customer notification.](evidence/screenshots/01-hpanel-cpu-limitation.jpg)
...
- **Network:** The provisioned 1 Gbps pipe is shared among multiple tenants -- Hostinger's own support confirmed "other users on the same infrastructure." Under realistic shared conditions, the practical monthly ceiling per tenant is approximately 13 TB, well below the advertised 32 TB.
...
This repository contains the complete forensic audit package, including benchmark data with timestamps, verbatim support communications, cryptographic seals, and a regulatory analysis.

---

## Support Chat: 6 Agents, 8 Communications, 3 Retractions in 6 Days
...
| 8 | Jun 9 | **SAE Team** | **CPU limitation active "for more than a week"** -- BEFORE suspension. Steal time caused by Hostinger's own rate limit, not shared infra (contradicts Aymene). Confirms hPanel/top discrepancy as "delivered vs demanded." Provides "Remove Limitation" button for "dedicated" resources. | Transcripts Section 11 |
...
>
> *"I want to make an immediate correction. No external abuse report exists, nor any legal infraction. The earlier mention of an 'abuse report' was an error on my part. [...] Sustained high usage at the limit (99-100%) can affect the **shared physical environment.** Nuestros sistemas estan disenados para proteger la integridad de todo el nodo cuando un solo VPS provoca un 'Steal Time' significativo o latencia para **otros usuarios en la misma infraestructura.** "*
...
| The 5 contradictory explanations | `02-timeline.md` | Transcript Section 11 (enumerated table) |
